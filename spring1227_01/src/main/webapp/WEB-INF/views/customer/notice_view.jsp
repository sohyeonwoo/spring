		...
		<div id="outbox">		
			...
			<div id="contents">
				...
				//태그 입력 시작
										...
										hdata += '<li class="txt">'+data.ccontent+'</li>';	
										hdata+='<li class="btn">';								
										hdata+='<a class="rebtn updateBtn" style="cursor: pointer; class="rebtn">수정</a>';								
										hdata+='<a class="rebtn delBtn" style="cursor: pointer; class="rebtn">삭제</a>';								
										hdata+='</li>';								
				...
				//태그 입력 시작
					...
					<div class="replyBox">
						...
						<ul>
							...
							<li class="btn">
								<a class="rebtn SaveBtn" style="cursor: pointer; class="rebtn">저장</a>
								<a class="rebtn Btn" style="cursor: pointer; class="rebtn">취소</a>
							</li>
						</ul>
						 -->
