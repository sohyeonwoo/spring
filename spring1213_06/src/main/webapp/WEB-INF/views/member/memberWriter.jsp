...
<html>
	...
	<body>
	  <div>
	   <h1>회원가입</h1>
	   <form name="m_frm" method="post" action="/notice/list">
		   <table>
		     <tr>
		       <th>아이디</th>
		       <td>
				   <input type="text" name="id" id="id" value="${bdto.id}">
		           <button type="button" id="idCheck">아이디 확인</button>
		       </td>
		     </tr>
		     <tr>
		       <th>패스워드</th>
		       <td><input type="password" name="pw" id="pw" value="${bdto.pw}"></td>
		     </tr>
		     <tr>
		       <th>이름</th>
		     ...
		     <tr>
		       <th>전화번호</th>
		       <td><input type="text" name="phone" id="phone" value="${bdto.phone}"></td>
		     </tr>
		     <tr>
		       <th>성별</th>
		       <td>
