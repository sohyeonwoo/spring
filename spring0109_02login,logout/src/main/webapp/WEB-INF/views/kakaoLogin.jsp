...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=13a733c8153728f3f95b098ca35e3d0b&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code"> 
      <li class="kakao"></li></a>
      <li class="naver"></li>
